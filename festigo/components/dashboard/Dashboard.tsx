          ...
          <div className="flex gap-4 justify-between ">
            ...
            <div className="flex flex-col gap-2 mt-4 pl-4">
              ...
              <div className="flex flex-col gap-3 bg-white p-3 px-4  rounded-xl pr-9">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-[#05CD99] text-sm font-semibold">
                    On track
                  </p>
                </div>
                  ...
                  {TransportorData.map((data, index) => (
                    <div key={index} className="flex gap-7">
                      ...
                      <div className="flex flex-col">
                        <h1 className="text-[#1B2559] font-bold text-[16px]">
                          {data.title}
                        </h1>
            ...
            <div className="flex flex-col justify-center items-center gap-2 mt-4">
              ...
              <div className="flex flex-col gap-3 h-fit bg-white p-5 rounded-xl w-fit px-10 ">
                <div>
                  <h1 className="text-[#1B2559] text-[34px] font-bold">
                    27 May
                  </h1>
                </div>
                <div className="flex flex-col gap-6">
                  {data.map((item, index) => (
                    <div className="flex gap-2" key={index}>
                      ...
                      <div className="flex flex-col">
                        <p className="text-[#1B2559] text-[16px]">
                          {item.title}
                        </p>
              ...
              <div className="flex flex-col bg-white p-5 rounded-xl w-fit h-fit gap-3 mt-1 pr-8 ">
                <h1 className="text-[#1B2559] font-bold text-xl">
                  Featured Venues
                </h1>
            ...
            <div className="flex flex-col justify-center items-center gap-6 mt-3">
              ...
              <div className="relative flex flex-col gap-2 bg-white justify-center items-center p-6 rounded-xl px-12">
                ...
                <p className="text-[24px] text-[#1B2559] font-bold ">
                  Radhika Sharma
                </p>
                ...
                <div className="flex justify-between gap-4 mt-6">
                  {eventData.map((data, index) => (
                    ...
                    >
                      ...
                      <p className="text-[#1B2559] font-bold text-[24px]">
                        {data.total}
                      </p>
                    </div>
                  ))}
              ...
              <div className="bg-[#F2FFEA] w-fit h-fit p-3 rounded-xl ">
                ...
                <div className="flex gap-4 justify-center items-center px-4 py-3 rounded-lg">
                  ...
                  <div>
                    <p className="text-[#A3AED0] text-[14px]">
                      Radhika ki Sautan:
                    </p>

                    <p className="text-[#1B2559] font-bold text-[15px]">
